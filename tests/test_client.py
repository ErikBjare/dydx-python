...
PRIVATE_KEY_1 = (
    "0x4f3edf983ac636a65a842ce7c78d9aa706d3b113bce9c46f30d7d21715b23b1d"  # noqa: E501
)
PRIVATE_KEY_2 = (
    "0x6cbed15c793ce57650b9877cf6fa156fbef513c4e6134f022a85b1ffdd59b2a1"  # noqa: E501
)
...
ORDER_HASH = (
    "0x444df3e619ce1865bb0138e89b3e92c29b1e57a6b35c4708822923bc60985c3d"  # noqa: E501
)
CANCEL_ORDER_HASH = (
    "0x45170c4ba6a19e3c9e25a4f3b3d65b9f2d988ad80f7a270528c03a7c484e1774"  # noqa: E501
)
...
class TestClient:
    ...
    def test_get_my_balances_success(self):
        ...
        with requests_mock.mock() as rm:
            ...
            uri = (
                "https://api.dydx.exchange/v1/accounts/"
    ...
    def test_get_my_orders_specified_success(self):
        ...
        with requests_mock.mock() as rm:
            ...
            result = client.get_my_orders(
                pairs=PAIRS, limit=limit, startingBefore=startingBefore
            )
            assert result == json_obj
    ...
    def test_get_orders_default_success(self):
        ...
        with requests_mock.mock() as rm:
            json_obj = tests.test_json.mock_get_orders_json
            uri = (
                "https://api.dydx.exchange/v1/dex/orders" + "?pairs=" + ",".join(PAIRS)
            )
            rm.get(uri, json=json_obj)
            result = client.get_orders(pairs=PAIRS)
            assert result == json_obj
    ...
    def test_get_my_fills_default_success(self):
        ...
        with requests_mock.mock() as rm:
            ...
            uri = (
                "https://api.dydx.exchange/v1/dex/fills"
                + "?makerAccountOwner="
                + client.public_address
                + "&makerAccountNumber="
                + str(client.account_number)
    ...
    def test_get_fills_default_success(self):
        ...
        with requests_mock.mock() as rm:
            json_obj = tests.test_json.mock_get_fills_json
            uri = "https://api.dydx.exchange/v1/dex/fills" + "?pairs=" + ",".join(PAIRS)
            rm.get(uri, json=json_obj)
    ...
    def test_get_my_trades_default_success(self):
        ...
        with requests_mock.mock() as rm:
            ...
            uri = (
                "https://api.dydx.exchange/v1/dex/trades"
                + "?makerAccountOwner="
                + client.public_address
                + "&makerAccountNumber="
                + str(client.account_number)
    ...
    def test_get_trades_default_success(self):
        ...
        with requests_mock.mock() as rm:
            json_obj = tests.test_json.mock_get_trades_json
            uri = (
                "https://api.dydx.exchange/v1/dex/trades" + "?pairs=" + ",".join(PAIRS)
            )
            rm.get(uri, json=json_obj)
    ...
    def test_create_order_success(self):
        def additional_matcher(request):
            ...
            assert body["order"]["makerAccountNumber"] == str(client.account_number)
            assert body["order"]["takerAccountOwner"] == client.TAKER_ACCOUNT_OWNER
            assert body["order"]["takerAccountNumber"] == str(
                client.TAKER_ACCOUNT_NUMBER
            )
            assert (
                abs(int(body["order"]["expiration"]) - utils.epoch_in_four_weeks())
                <= 10
            )
        ...
        with requests_mock.mock() as rm:
            ...
            result = client.create_order(
                makerMarket=1, takerMarket=0, makerAmount=2000, takerAmount=1000
            )
            assert result == json_obj
    ...
    def test_cancel_order_success(self):
        def additional_matcher(request):
            return (
                "Bearer " + CANCEL_ORDER_SIGNATURE == request.headers["Authorization"]
            )
        ...
        with requests_mock.mock() as rm:
            ...
            result = client.cancel_order(hash=ORDER_HASH)
            assert result == json_obj
